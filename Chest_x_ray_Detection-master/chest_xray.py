...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 1, 591, 41))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(200, 430, 591, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
...
"}")
    ...
    def predict_result(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        if result[0][0]>0.5:
            self.label_3.setText(_translate("MainWindow", "Result is Normal"))
            print("Result is Normal")
            speak("Result is Normal")
        else:
            self.label_3.setText(_translate("MainWindow", "Result is PNEUMONIA"))
            print("Result is PNEUMONIA")
            speak("Result is PNEUMONIA")
